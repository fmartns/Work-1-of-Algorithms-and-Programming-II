...
int main() {
    ...
    // Define valor da multa por dia de atraso.
                    ...
                    case 3:
                        ...
                        switch(choice){
                            case 1:
                                ...
                                cin >> word;
                                findBooks(books, MAX_BOOKS, 1, word);
                                break;
                            case 2:
                                cout << "Digite o termo de pesquisa: ";
                                cin >> word;
                                findBooks(books, MAX_BOOKS, 2, word);
                                break;
                            case 3:
                                cout << "Digite o termo de pesquisa: ";
                                cin >> word;
                                findBooks(books, MAX_BOOKS, 3, word);
                                break;
                            case 4:
                                break;
                            default:
